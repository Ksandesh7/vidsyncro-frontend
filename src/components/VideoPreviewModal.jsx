...
const VideoPreviewModal = ({ title, description, thumbnailIdeas, mpd, vtt, onClose }) => {
      ...
      <div className="relative bg-gray-900 w-3/4 h-3/4 max-w-screen-lg p-8 rounded-lg">
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className="w-full lg:w-1/2 lg:mr-4 h-full">
            <VideoPlayer src={`https://d9acgijza706g.cloudfront.net/${mpd}`} subtitles={[{ lang: 'en', label: 'English', url: `https://d9acgijza706g.cloudfront.net/${vtt}` }]} />
          </div>
          {/* Information */}
